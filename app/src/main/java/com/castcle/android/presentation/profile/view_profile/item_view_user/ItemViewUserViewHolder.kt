...
class ItemViewUserViewHolder(
    private val binding: ItemViewUserBinding,
    private val compositeDisposable: CompositeDisposable,
    private val listener: ViewProfileListener,
) : CastcleViewHolder<ItemViewUserViewEntity>(binding.root) {

    override var item = ItemViewUserViewEntity()
    ...
    override fun bind(bindItem: ItemViewUserViewEntity) {
        with(binding) {
            ...
            item.user.let {
                ...
                with(itemDetailProfile) {
                    clDetailProfile.gone()
                    it.dob?.let {
                        clDetailProfile.visible()
                        tvBirthdayDescription.text = it.toFormatDateBirthDate()
                    }
                }
