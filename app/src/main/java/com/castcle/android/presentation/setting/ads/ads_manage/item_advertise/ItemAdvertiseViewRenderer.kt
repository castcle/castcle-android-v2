...
class ItemAdvertiseViewRenderer : CastcleViewRenderer<ItemAdvertiseViewEntity,
    ItemAdvertiseViewHolder,
    AdvertiseListener>(R.layout.item_history_advertise) {
    ...
    override fun createViewHolder(
        ...
        ItemHistoryAdvertiseBinding.inflate(
