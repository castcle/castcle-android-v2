...
class EditProfileViewRenderer : CastcleViewRenderer<EditProfileViewEntity,
    EditProfileViewHolder,
    EditNewProfileListener>(R.layout.item_edit_detail_new_profile) {

    override fun createViewHolder(
        parent: ViewGroup,
        listener: EditNewProfileListener,
        compositeDisposable: CompositeDisposable,
    ) = EditProfileViewHolder(
        ItemEditDetailNewProfileBinding.inflate(
