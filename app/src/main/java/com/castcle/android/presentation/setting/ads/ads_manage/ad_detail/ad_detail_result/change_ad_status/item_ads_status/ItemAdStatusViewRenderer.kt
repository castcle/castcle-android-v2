...
class ItemAdStatusViewRenderer : CastcleViewRenderer<ItemAdStatusViewEntity,
    ItemAdStatusViewHolder,
    ChangeAdStatusListener>(R.layout.item_ad_status) {

    override fun createViewHolder(
        parent: ViewGroup,
        listener: ChangeAdStatusListener,
        compositeDisposable: CompositeDisposable
    ) = ItemAdStatusViewHolder(
        ItemAdStatusBinding.inflate(
