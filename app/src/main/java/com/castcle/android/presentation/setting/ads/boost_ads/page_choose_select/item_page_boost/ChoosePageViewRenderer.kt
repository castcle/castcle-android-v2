...
class ChoosePageViewRenderer : CastcleViewRenderer<ChoosePageViewEntity,
    ChoosePageViewHolder,
    PageChooseListener>(R.layout.item_page_boost) {
