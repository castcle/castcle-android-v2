...
class ItemAdContentViewRenderer : CastcleViewRenderer<ItemAdContentViewEntity,
    ItemAdContentViewHolder,
    BoostAdsListener>(R.layout.item_ad_content_preview) {
    ...
    override fun createViewHolder(
        ...
        ItemAdContentPreviewBinding.inflate(
