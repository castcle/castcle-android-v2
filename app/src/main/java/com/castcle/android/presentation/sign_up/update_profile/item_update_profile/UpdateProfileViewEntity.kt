...
data class UpdateProfileViewEntity(
    ...
    override val uniqueId: String = "${R.layout.item_update_profile}",
) : CastcleViewEntity {

    override fun sameAs(isSameItem: Boolean, target: Any?) = if (isSameItem) {
        target?.cast<UpdateProfileViewEntity>()?.uniqueId == uniqueId
    } else {
        target?.cast<UpdateProfileViewEntity>() == this
    }

    override fun viewType() = R.layout.item_update_profile
}