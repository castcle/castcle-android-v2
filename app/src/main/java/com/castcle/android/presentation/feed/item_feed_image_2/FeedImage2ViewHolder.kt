...
class FeedImage2ViewHolder(
    private val binding: ItemFeedImage2Binding,
    private val compositeDisposable: CompositeDisposable,
    private val listener: FeedListener,
    private val referenceType: CastType?,
) : CastcleViewHolder<FeedImage2ViewEntity>(binding.root), UserBarListener, ParticipateBarListener {

    override var item = FeedImage2ViewEntity()
    ...
    override fun bind(bindItem: FeedImage2ViewEntity) {
        val marginBottom = if (
