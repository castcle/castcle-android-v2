...
data class FeedTextViewEntity(
    ...
    override fun sameAs(isSameItem: Boolean, target: Any?) = if (isSameItem) {
        target?.cast<FeedTextViewEntity>()?.uniqueId == uniqueId
    } else {
        target?.cast<FeedTextViewEntity>() == this
    }

    override fun viewType() = R.layout.item_feed_text
