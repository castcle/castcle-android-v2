...
class AdDialogFilterViewRenderer :
    CastcleViewRenderer<AdDialogFilterViewEntity,
        AdDialogFilterViewHolder,
        AdDialogFilterListener>(R.layout.item_wallet_dashboard_dialog_filter) {

    override fun createViewHolder(
        parent: ViewGroup,
        listener: AdDialogFilterListener,
