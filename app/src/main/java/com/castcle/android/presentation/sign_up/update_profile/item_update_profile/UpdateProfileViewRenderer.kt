...
class UpdateProfileViewRenderer : CastcleViewRenderer<UpdateProfileViewEntity,
    UpdateProfileViewHolder,
    UpdateProfileListener>(R.layout.item_update_profile) {
    ...
    override fun createViewHolder(
        ...
        ItemUpdateProfileBinding.inflate(
