...
class WalletAddressViewHolder(
    private val binding: ItemWalletAddressBinding,
    private val compositeDisposable: CompositeDisposable,
    private val listener: WalletAddressListener,
) : CastcleViewHolder<WalletAddressViewEntity>(binding.root) {

    override var item = WalletAddressViewEntity()
    ...
    override fun bind(bindItem: WalletAddressViewEntity) {
