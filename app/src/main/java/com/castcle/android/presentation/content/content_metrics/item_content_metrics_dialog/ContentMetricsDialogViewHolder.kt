...
class ContentMetricsDialogViewHolder(
    private val binding: ItemContentMetricsDialogBinding,
    private val compositeDisposable: CompositeDisposable,
    private val listener: ContentMetricsListener,
) : CastcleViewHolder<ContentMetricsDialogViewEntity>(binding.root) {

    override var item = ContentMetricsDialogViewEntity()
    ...
    override fun bind(bindItem: ContentMetricsDialogViewEntity) {
