...
//
//
//  Created by sklim on 18/2/2022 AD at 09:03.

data class BoostAdRequest(
    ...
    @SerializedName("dailyBidType")
    var dailyBidType: String = "",
    @SerializedName("dailyBidValue")
    var dailyBidValue: Double = 0.0,
