...
data class BoostAdsWithResultEntity(
    @Embedded
    val balance: BoostAdsEntity? = BoostAdsEntity(),

    @Relation(
        parentColumn = "${TABLE_BOOST_ADS}_relationId",
    ...
    @Relation(
        parentColumn = "${TABLE_BOOST_ADS}_castRelationId",
